...
/// The possible alignments of a [CustomDrawer].
enum DrawerAlignment {
  /// Denotes that the [CustomDrawer] is at the start side of the [Scaffold].
  ///
  ...
  /// Denotes that the [CustomDrawer] is at the end side of the [Scaffold].
  ///
...
/// [CustomDrawer] when a [CustomDrawer] is available in the [Scaffold]. The [Scaffold]
...
/// a [CustomDrawer]. A user taps the "menu" icon in the [AppBar] to open the
/// [CustomDrawer]. The [CustomDrawer] displays four items: A header and three menu items.
/// The [CustomDrawer] displays the four items using a [ListView], which allows the
...
/// See also:
///
///  * [Scaffold.drawer], where one specifies a [CustomDrawer] so that it can be
///    shown.
///  * [Scaffold.of], to obtain the current [ScaffoldState], which manages the
///    display and animation of the drawer.
///  * [ScaffoldState.openDrawer], which displays its [CustomDrawer], if any.
...
/// Provides interactive behavior for [CustomDrawer] widgets.
///
...
/// See also:
///
///  * [CustomDrawer], a container with the default width of a drawer.
///  * [Scaffold.drawer], the [Scaffold] slot for showing a drawer.
class DrawerController extends StatefulWidget {
  /// Creates a controller for a [CustomDrawer].
  ///
  /// Rarely used directly.
  ///
  /// The [child] argument must not be null and is typically a [CustomDrawer].
  ...
  /// The widget below this widget in the tree.
  ///
  /// Typically a [CustomDrawer].
  final Widget child;

  /// The alignment of the [CustomDrawer].
  ///
  /// This controls the direction in which the user should swipe to open and
  /// close the drawer.
  final DrawerAlignment alignment;

  /// Optional callback that is called when a [CustomDrawer] is opened or closed.
  ...
  /// Determines if the [CustomDrawer] can be opened with a drag gesture.
  ///
